...
export default function ProductsPage() {
  return <>
    <section data-hero className="relative isolate min-h-screen overflow-hidden bg-[#062E35] text-[#F7F1E8]">
      <Image src="/images/home-desktop-hero.png" alt="Trải nghiệm thể thao dưới nước cùng Hubi Việt Nam" fill priority unoptimized sizes="100vw" className="hidden object-cover object-bottom md:block" />
      <Image src="/images/products/mobile-hero-v2.png" alt="Mặt nước lúc hoàng hôn" fill priority unoptimized sizes="100vw" className="object-cover object-center -translate-y-[3%] scale-[1.06] md:hidden" />
