...
export function PackageDialog({ children }: { children: ReactNode }) {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="mt-5 inline-flex min-h-11 items-center justify-center rounded-md bg-hubi-teal px-4 py-3 text-sm font-medium text-hubi-cream shadow-[0_8px_20px_rgb(var(--hubi-deep-teal-rgb)/.16)] transition-colors hover:bg-hubi-deep-teal focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-hubi-teal">Xem cấu hình gói bán</button>
